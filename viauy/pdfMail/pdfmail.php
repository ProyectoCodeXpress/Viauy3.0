...
require '../viauy/vendor/autoload.php'; // Carga la librería PHPMailer
//require '../vendor/tecnickcom/tcpdf/config/tcpdf_config.php';
require '../viauy/config/secrets.php';


use PHPMailer\PHPMailer\PHPMailer;

require_once('../viauy/vendor/tecnickcom/tcpdf/tcpdf.php');
...
$pdf_filename = $_SERVER['DOCUMENT_ROOT'] . '/3era/viauy2.0/viauy/mi_pdf_' . $unique_id . '.pdf';
...
$mail->addAddress('lcalvetti1@gmail.com', 'Leandro'); // Dirección de correo destino
